...
if __name__ == '__main__':
    from trainer.lib.data_api import Session, ImStack, SemSegTpl, SemSegMask, reset_schema, MaskType
    ...
    mask1 = SemSegMask.build_new(gt_arr=np.zeros((28, 28, 3), dtype=np.bool), sem_seg_tpl=ss_tpl)
    mask2 = SemSegMask.build_new(gt_arr=np.zeros((28, 28, 3), dtype=np.bool), sem_seg_tpl=ss_tpl)
    ...
    mask1 = SemSegMask.build_new(np.zeros_like(skimage.data.astronaut(), dtype=np.bool), sem_seg_tpl=ss_tpl)
